...
export default function CheckoutScreen({ route, navigation }) {
  ...
  return (
    <View style={{flex:1, padding:20, backgroundColor:'#fff'}}>
        ...
        <Text style={styles.value}>Rp {Number(movie.ticket_price).toLocaleString()}</Text>
...
const styles = StyleSheet.create({
    ...
    totalContainer: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 30 },
